...
<!DOCTYPE html>
<title>Patunay sa Kuryente</title>
<html id="clearance">
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $row)
                            {
                                ...
                                <form action="function.php" method="POST" id="kuryente">
                                ...
                                <!-- END -->
                                    ...
                                    <p class="intro"><b>ITO AY ISANG PAGPAPATUNAY</b> na ang linya ng kuryente na nasa pangalan ni <b><?php echo $row['firstname']; ?> <?php echo $row['middlename']; ?> <?php echo $row['lastname'];?></b> na ang Account Number ay <b><?php echo $row['KuryenteAccountNo']; ?></b> ay ginagamit sa kasalukuyan ni <b><?php echo $row['firstname']; ?> <?php echo $row['middlename']; ?> <?php echo $row['lastname'];?></b> na naninirahan sa <b>PUROK <?php echo $row['purokNo'];?></b> ng Barangay <?php echo ucwords(strtolower($row['barangay'])); ?>, <?php echo ucwords(strtolower($row['city'])); ?>, <?php echo ucwords(strtolower($row['province'])); ?>.<br></p>
...
<br>
    ...
    <button class="noprint" id="printpagebutton" form="kuryente" name="insert_kuryente" onclick="PrintElem('#clearance')" style="position: fixed">Print</button>
