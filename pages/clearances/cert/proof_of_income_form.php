                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $row)
                            {
                                ...
                                <form action="function.php" method="POST" id="income">
                                ...
                                <!-- END -->
                                    ...
                                    <p class="intro"><b>ITO AY ISANG PAGPAPATUNAY</b> na si <b><?php echo $row['firstname']; ?> <?php echo $row['middlename']; ?> <?php echo $row['lastname'];?>, <?php echo $row['age'];?></b> taong gulang, walang asawa at naninirahan sa <b>PUROK <?php echo $row['purokNo'];?></b> ng Barangay na ito ay pinatutunayang naghahanap-buhay bilang isang <?php echo $row['work']; ?> at kumikita ng halagang <b>(<?php echo $row['income']; ?>)</b> sa loob ng isang buwan.<br></p>
...
<br>
    ...
    <button class="noprint" id="printpagebutton" form="income" name="insert_proof_income" onclick="PrintElem('#clearance')" style="position: fixed">Print</button>
