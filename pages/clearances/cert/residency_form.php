                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            foreach($query_run as $row)
                            {
                                ...
                                <form action="function.php" method="POST" id="residency">
                                ...
                                <!-- END -->
                                    ...
                                    <p class="intro2"><b>ITO AY ISANG PAGPAPATUNAY</b> na si <b><?php echo $row['firstname']; ?> <?php echo $row['middlename'];?> <?php echo $row['lastname'];?></b> ay lehitimo at pirmihang naninirahan dito sa <b>PUROK <?php echo $row['purokNo'];?></b> ng Barangay na ito sa loob ng <b><?php echo $row['age'];?></b> taon simula noong <b><?php $birthdate = $row['birthdate']; $date = new DateTime($birthdate); $formattedDate = $date->format('Y'); echo $formattedDate; ?>.</b><br></p>
...
<br>
    ...
    <button class="noprint" id="printpagebutton" form="residency" name="insert_residency" onclick="PrintElem('#clearance')" style="position: fixed">Print</button>
