                                ...
                                ?>
                                            ...
                                            <td>
                                                <form action="function.php" method="POST" class="d-inline">
                                                    <button type="button" class="button-color btn btn-sm" title="View" data-bs-toggle="modal" data-bs-target="#Archive_View<?php echo $row['id']; ?>"><i class="bi bi-eye-fill"></i></button>
                                                    ...
                                                    if($query)
                                                    {
                                                        echo '
                                                            <form action="function.php" method="POST">
                                                                <button type="button" class="button-color btn" title="Set Active" data-bs-toggle="modal" data-bs-target="#setActive'.$row['id'].'">Restore</button>
                                                            </form>
                                                        ';
                                                    }
                                                ?>
