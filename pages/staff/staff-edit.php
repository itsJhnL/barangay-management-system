        ...
        <div class="container">
          ...
          <form action="function.php" method="POST">
            ...
            <!-- <div class="row mb-2">
              <label >Address</label>
              <div class="col">
                <input type="text" class="form-control" name="address" placeholder="" autocomplete="off" oninput="this.value = this.value.toUpperCase()" onkeyup="lettersOnly(this)" required value="<?php echo $staff['address']?>">
              </div>
            </div> -->
            ...
            <div class="row g-2 mb-3">
              <div class="col-md-6">
                ...
                <input type="hidden" name="province" value="<?php echo $staff['province']; ?>">
                <input type="hidden" name="City" value="<?php echo $staff['City']; ?>">
                <input type="hidden" name="barangay" value="<?php echo $staff['barangay']; ?>">
                <select class="form-select" name="province" id="Province1<?php echo $staff['id']; ?>" required>
                  <option selected disabled><?php echo $staff['province']; ?></option>
                </select>
                <small id="emailHelp" class="form-text text-muted">Province</small>
              </div>
              <div class="col-md-6 ">
                <select class="form-select" name="City" id="CityTown1<?php echo $staff['id']; ?>" required>
                  <option selected disabled><?php echo $staff['City']; ?></option>
                </select>
                <small id="emailHelp" class="form-text text-muted">City/Town</small>
              </div>
              <div class="col-md-6 ">
                <select class="form-select" name="barangay" id="Barangay1<?php echo $staff['id']; ?>" required>
                  <option selected disabled><?php echo $staff['barangay']; ?></option>
                </select>
            ...
            <div class="row g-2 mb-2">
              <div class="col">
                ...
                <input type="text" class="form-control" name="contactNo" maxlength="11" placeholder="" autocomplete="off" required value="<?php echo $staff['contactNo']; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" / required>
                ...
                <?php 
                  if($staff['gender'] == "MALE")
                  {
                    ...
                    <select class="form-select" name="gender" autocomplete="off" required>
                      <option value="MALE">'.strtoupper($staff['gender']).'</option>
                  ...
                  elseif($staff['gender'] == "FEMALE")
                  {
                    ...
                    <select class="form-select" name="gender" autocomplete="off" required>
                      <option value="FEMALE">'.strtoupper($staff['gender']).'</option>
