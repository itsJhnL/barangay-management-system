...
if(isset($_POST['save_resident']))
{
  ...
  $BusinessDateStart = mysqli_real_escape_string($con, $_POST['BusinessDateStart']);
  $KuryenteAccountNo = mysqli_real_escape_string($con, $_POST['KuryenteAccountNo']);
...
/*     $folderPath = 'images/';
    ...
    // $birthdate = date('F d Y', str($_POST['birthdate']));
