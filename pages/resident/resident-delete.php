...
<div class="modal fade" id="Delete_Resident<?php echo $resident['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="function.php" method="POST">
              ...
              <input type="hidden" name="firstname" value="<?php echo $resident['firstname']?>"/>
              <input type="hidden" name="lastname" value="<?php echo $resident['lastname']?>"/>
              ...
              <div class="modal-body text-center" style="margin-top: -20px">
                ...
                <p><b>NAME: <u><?php echo $resident['firstname'];?> <?php echo $resident['lastname']; ?></u></b></p>
